...
public class BinaryLessThanOperatorTest extends AbstractJtwigTest {
    BinaryLessThanOperator underTest = new BinaryLessThanOperator("<", 0);
    ...
    public void generalTest() throws Exception {
        ...
        assertFalse(underTest.render(renderContext, position, new Object(), 1));
    }
}
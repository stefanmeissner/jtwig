...
public class BinaryModulusOperator extends BinaryOperator {
    private static final Logger LOGGER = LoggerFactory.getLogger(BinaryModulusOperator.class);

    public BinaryModulusOperator(String name, int precedence) {
